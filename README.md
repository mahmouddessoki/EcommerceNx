...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/ik9JSxx7TP)
...
```sh
npx nx serve FlowerApp
```

To create a production bundle:

```sh
npx nx build FlowerApp
```

To see all available targets to run for a project, run:

```sh
npx nx show project FlowerApp
```
